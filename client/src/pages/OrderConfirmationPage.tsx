...
export const OrderConfirmationPage: React.FC = () => {
  ...
  const orderNumber = orderState?.orderNumber || `DL-${Date.now().toString(36).toUpperCase()}`;
  const total = orderState?.total || 0;
  const email = orderState?.email || 'your email';
  ...
  return (
    <section className="bg-[#FAF7F2] min-h-screen py-20">
      <div className="max-w-2xl mx-auto px-6 text-center">
        ...
        {/* Header */}
        <h1 className="text-5xl font-serif text-slate-900 mb-4 italic animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100">
          Thank You!
        </h1>
        <p className="text-2xl font-serif text-slate-500 italic mb-12 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200">
          Your order has been placed successfully.
        </p>

        {/* Order Details Card */}
        <div className="bg-white rounded-[2rem] p-10 mb-12 text-left animate-in fade-in slide-in-from-bottom-4 duration-500 delay-300">
        ...
        {/* Estimated Delivery */}
        <div className="bg-white/50 rounded-2xl p-6 mb-12 border border-[#E8E2D9] animate-in fade-in slide-in-from-bottom-4 duration-500 delay-400">
