...
export default function HomePage() {
  ...
  const { toggleWishlist, toggleSaveForLater, addToCart, isWishlisted, isSaved } = useCartStore();
  const {
    comparisonList,
    pendingProductIds,
  ...
  const handleSafetyAudit = async (product: Product) => {
    try {
