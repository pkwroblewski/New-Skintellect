...
export default function ComparePage() {
  ...
  const { selectedProduct, comparisonTarget, analysis, resetComparison } = useComparisonStore();
  const { addToCart, toggleWishlist, toggleSaveForLater, isWishlisted, isSaved } = useCartStore();
