...
export function SafetyModal({ product, report, onClose }: SafetyModalProps) {
  return (
    <div
    ...
    >
      <div
        className="relative bg-[#FAF7F2] w-full max-w-4xl max-h-[90vh] overflow-hidden rounded-[3rem] border border-[#E8E2D9] shadow-2xl flex flex-col"
